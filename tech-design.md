...
[technical design](docs/design/zoc-reaction-v1.md). `ZOR-TASK-002A`-`002C` complete the dormant
Rules/Content/fixture gate, including strict Content v5 readback, canonical identity evidence, and
direct-only non-additive controlled-location derivation; ruleset 7 and Content schema 4 remain
active until the coordinated migration. `ZOR-TASK-003A` is next.
...
`ZOR-TASK-002A`-`002C` implement only the dormant Rules/Content/fixture gate; `003A` and later
slices remain dependency-gated.
