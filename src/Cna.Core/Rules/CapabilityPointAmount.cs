...
public sealed record CapabilityPointAmount : IComparable<CapabilityPointAmount>
{
    public CapabilityPointAmount(long numerator, int denominator)
    {
    ...
    public static CapabilityPointAmount Zero { get; } = new(0, 1);

    public long Numerator { get; }

    public int Denominator { get; }

    public int CompareTo(CapabilityPointAmount? other)
    {
    ...
    public static CapabilityPointAmount operator +(
        CapabilityPointAmount left,
        CapabilityPointAmount right) => CreateChecked(
        ...
        CapabilityPointAmount right)
    {
        ...
        if (numerator.Sign < 0)
        {
            throw new ArgumentOutOfRangeException(
                nameof(right),
                "Capability Point subtraction cannot produce a negative amount.");
        }
    ...
    public static bool operator <(
        CapabilityPointAmount left,
        CapabilityPointAmount right) => left.CompareTo(right) < 0;
    ...
    private static CapabilityPointAmount CreateChecked(
        ...
        BigInteger denominator)
    {
        ...
        if (numerator > long.MaxValue || denominator > int.MaxValue)
        {
            throw new OverflowException(
                "The exact Capability Point result is outside the supported representation.");
        }
    ...
    private static CapabilityPointAmount Require(CapabilityPointAmount? amount) =>
