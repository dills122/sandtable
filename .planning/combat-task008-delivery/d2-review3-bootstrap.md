...
Review instance 3 of3 for Task008 D2 Reserve completion codec. Use independent-review reviewer mode.
...
dotnet test --project tests/Cna.Core.Tests/Cna.Core.Tests.csproj --no-build --filter-class '*CombatReserveCompletionTests' --filter-class '*CombatReserveDesignationTests' '-bl:/tmp/d2-review3-{}.binlog'
...
Only write .planning/combat-task008-delivery/d2-review3-report.md; no code/docs edits/staging/commits.
