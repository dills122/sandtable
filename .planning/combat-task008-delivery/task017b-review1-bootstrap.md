...
preserve concurrent integration work. Own only task017b-review1-preliminary.md and
 task017b-review1-report.md in integration .planning/combat-task008-delivery; logs in own clone/tmp.
...
Use $independent-review in reviewer mode. Review instance 1 of3. Work from neutral bootstrap first,
