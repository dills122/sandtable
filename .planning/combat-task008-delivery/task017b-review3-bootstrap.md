...
preserve concurrent integration work. Own only task017b-review3-preliminary.md and
 task017b-review3-report.md in integration .planning/combat-task008-delivery; logs in own clone/tmp.
...
commands. Independently restore and rebuild FULL Sandtable.slnx in Release, then focused adapter/A1/A2 and Boundary tests.
...
Use $independent-review in reviewer mode. Review instance 3 of3. Work from neutral bootstrap first,
