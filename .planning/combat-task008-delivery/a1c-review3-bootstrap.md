...
Review instance: **3 of 3**. User reserves one additional final round only if blockers remain after
...
`dotnet test --project tests/Cna.Core.Tests/Cna.Core.Tests.csproj --no-build --filter-class '*CombatCreationBindingTests' '-bl:/tmp/a1c-review3-{}.binlog'`
...
Write only `a1c-review3-report.md` in this planning directory, including preliminary findings before
