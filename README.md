...
| Combat and continual cycle | Dormant Core reviewed through isolated Release | Creation and inherited-history restore, identity, decisions, costs, results, loss/retreat settlement, custody, relationships and round closure are implemented and reviewed through Task016. Isolated Release bases and lifecycle (017A1/A2) are also reviewed, including timed choices, deterministic fallback and completion. Public Combat play and full cycle closure remain future gates. |
