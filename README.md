...
1. Continue Task008's bounded Combat persistence children: initial World7 canonical readback and dormant Rules10 manifest are implemented; next add Setup7/configuration/request and Created11 creation binding, then Snapshot12 and inherited event families. Dormant Tasks005–007 Rules, Content and World foundations are implemented.
