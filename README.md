...
| Combat and continual cycle | Checkpoint B accepted; dormant Tasks005–007 and Task008 creation codecs implemented; gameplay dormant | 28 creation-rooted traces and Task004 acceptance map all 72 requirements. Selected Rules, Content7 and World7 state are implemented; initial World7, Rules10, Setup7, configuration, creation request/Created11 and creation-only Snapshot12 codecs have exact C# parity; A1c/A2 and inherited slices through F1 are merged to main; B1 opening replay is reviewed in PR126; C Weather replay is reviewed in PR127; B2 stage-entry is reviewed in PR128; D1 own Reserve designation is reviewed in PR129; D2 completion codec is reviewed in PR130;019A first opening is reviewed in PR131; E1 ordinary Move4 is reviewed in PR132; E2/G1 route lifecycle is reviewed in PR133; G2 Combat-entry transition is reviewed in PR134; F1 Reaction trigger is reviewed in PR135; F2 participant lifecycle is implemented and reviewed in PR136 (focused16/full2,060; three independent rounds); F3 direct closure is implemented and reviewed in PR136 (focused25/full2,069; three independent rounds); F4 active fallback is implemented and reviewed in PR136 (focused29/full2,080; three independent rounds). F5 second reactor move is implemented and reviewed in PR136 (focused22/full2,093; three independent rounds). F6 completion is implemented and reviewed in PR136 (focused24/full2,104; three independent rounds). Task008 Initial H Core codec/replay gate is complete in PR136; publication evidence and later gameplay, public activation and simulator gates remain open. |
...
1. Continue Task008's bounded Combat persistence children: initial World7 readback, dormant Rules10 manifest, and Setup7/configuration codecs are merged; A1c creation request/Created11 is reviewed in PR124. A2 creation-only Snapshot12 is reviewed in PR125. B1 opening replay is reviewed in PR126; C Weather replay is reviewed in PR127. B2 stage-entry is reviewed in PR128. D1 own Reserve designation is reviewed in PR129; D2 completion codecs are reviewed in PR130. Task019A same-event atomic projection is reviewed in PR131. E1 ordinary Move4 is reviewed in PR132; E2/G1 route lifecycle is reviewed in PR133; G2 Combat-entry transition is reviewed in PR134; F1 Reaction trigger is reviewed in PR135; F2 participant lifecycle is implemented and reviewed in PR136 (focused16/full2,060; three independent rounds); F3 direct closure is implemented and reviewed in PR136 (focused25/full2,069; three independent rounds); F4 active fallback is implemented and reviewed in PR136 (focused29/full2,080; three independent rounds). F5 second reactor move is implemented and reviewed in PR136 (focused22/full2,093; three independent rounds). F6 completion is implemented and reviewed in PR136 (focused24/full2,104; three independent rounds). Selected inherited Reaction continuations are implemented; [H0 literal Snapshot12 contract](docs/specs/combat-inherited-snapshot-v1.md) passed368cuts and three independent reviews. H1 pre-cycle retained-history routing is accepted (focused53/full2,157; dev review, three independent rounds and remote CI pass); H2 Movement/Breakdown routing is accepted (focused70/full2,174; dev review, three independent rounds and remote CI pass); H3 Reaction routing is accepted (focused129/full2,233; dev review, three independent rounds and remote CI pass); H4 literal-root restore is accepted (368 exact roots/286 histories; focused11/full2,244/boundary81; dev review, three independent rounds and remote CI pass). Initial H Core codec/replay gate is complete; Task009A inherited assessment and identity bindings is accepted (focused10/full2,254/boundary81; dev review, three ordinary rounds plus one conditional isolated final review, exact-head CI). Task009B is accepted (full2,258/boundary81; dev review, three independent rounds and exact-head CI). Task009 dormant mechanisms are complete;010A actual empty selection/traversal is accepted (full2,265/boundary81; dev review, three independent rounds and exact-head CI). Timed selection010B is accepted (full2,277/boundary81; dev review, three independent rounds and exact-head CI). Cumulative routing010C is accepted (full2,284/boundary81; dev review, three independent rounds and exact-head CI). Parent010 dormant gate is complete; private seals/Prepared011 is accepted (full2,292/boundary81; dev review, three independent rounds and exact-head CI). Atomic commitment012 is accepted (full2,301/boundary81; dev review, three independent rounds and exact-head CI). Result/cursor013 is accepted (full2,311/boundary81; dev review, three independent rounds and exact-head CI). Loss/retreat014 is accepted (full2,318/boundary81; dev review, three independent rounds and exact-head CI). Custody015 implementation is under verification; relationship and round closure016 follows its review gate. Actual publication proof remains open under HOST-PUB-001. Dormant Tasks005–007 Rules, Content and World foundations are implemented.
