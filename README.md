...
| Combat and continual cycle | Dormant Core reviewed through round closure | Creation and inherited-history restore, identity, decisions, costs, results, loss/retreat settlement, custody, relationships and round closure are implemented and reviewed through Task016. Isolated Release base validation (017A1) is also reviewed; native isolated Release lifecycle (017A2) is implemented with acceptance checks pending. Public Combat play and full cycle closure remain future gates. |
