...
| Combat and continual cycle | Contracts complete through parent003 | 28 creation-rooted traces reconcile future Combat/cycle authority, but handlers are not registered in runtime. Versioned round clock and Task004A1 side contracts now preserve privacy under clock faults. Result/settlement integration, remaining side families and Exercise contracts remain open. |
