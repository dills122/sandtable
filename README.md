...
| Combat and continual cycle | Dormant Core reviewed through losses and retreat | Creation and inherited-history restore, identity, decisions, costs, results, and loss/retreat settlement are implemented and reviewed through Task014. Task015 custody is merged and tested; independent review acceptance remains pending. Public Combat play and full cycle closure remain future gates. |
...
1. Finish Task015 custody review, then implement relationship/round closure, Reserve Release,
   relation-aware Movement, and guarded repeat/finish (Tasks016–019).
