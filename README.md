...
| Combat and continual cycle | Not implemented or activated | Contract-frozen through `003D2c.3o`; freeze remaining `.3` capability families, finish `.4` composition/side contracts, then dormant runtime, public activation, and Runner gates |
...
mandatory resolution. Second participant moves, multiple-opportunity Reaction, vehicle profiles
and D2c.4 remain open.
