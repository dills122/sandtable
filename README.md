...
Owner accepted Breakdown decisions `BRK-DEC-004`–`007`; [BRK-TASK-001 contract freeze](docs/specs/breakdown-adjudication-v1.md) is complete. [Task 002 dormant outcome rules](docs/research/breakdown-outcome-rules.md) are implemented and the full gate passes; independent review is Ready. Next is Task 003 campaign contracts and the certified Truck fixture. The certified Truck profile defers public positive ZOC and motorized-infantry losses; its [fixture migration](docs/specs/breakdown-fixture-migration.v1.json) preserves historical coverage. Current runtime still stops at Breakdown; adjudication is unimplemented.
