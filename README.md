...
| Combat and continual cycle | Dormant Core reviewed through round closure | Creation and inherited-history restore, identity, decisions, costs, results, loss/retreat settlement custody, relationships and round closure are implemented and reviewed through Task016. Public Combat play and full cycle closure remain future gates. |
...
1. Implement relationship/round closure, Reserve Release,
