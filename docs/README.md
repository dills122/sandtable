...
completion plus active-participant second movement through `003D2c.3p`; Combat runtime, public activation,
...
- Combat: [source inventory](research/combat-cycle-source-inventory.md) and completed
  ...
  route identity and active opportunity; later completion and multiple-opportunity/vehicle profiles stay open.
  ...
  completion receipt; participant completion after the second move, multiple-opportunity Reaction, vehicle profiles and `.4`
