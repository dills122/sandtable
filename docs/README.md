...
- Movement Foundation: [specification](specs/movement-foundation-v1.md),
  ...
  [source/contract research](research/movement-foundation-spike.md). Tasks 001-007 are implemented;
  Task 006 freezes dormant move/completion candidates and Task 007 adds internal authoritative
  adjudication, event projection, and replay. Task 008 public membership/completion is next, and
  Movement campaign actions deliberately remain unavailable until then.
