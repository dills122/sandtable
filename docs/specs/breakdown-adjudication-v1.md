...
**Status:** BRK-TASK-001 contract freeze complete, 2026-09-05. Production Tasks 002–007 pending.
...
The inherited twelve acceptance IDs are frozen here; none is claimed as a passing Core test yet.
...
research decision loop. Next task is **BRK-TASK-002: dormant outcome rules and exact loss arithmetic**.
