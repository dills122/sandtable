...
This specification and its [wire contract](breakdown-wire-contract-v1.md) govern the implemented
bounded public Breakdown capability. [Design/task plan](../design/breakdown-adjudication-v1.md) assigns implementation
