...
| Combat and continual cycle | Checkpoint B accepted; Tasks005–007 and Task008 A0/A1a/A1b merged, parent008 still open | **Gameplay not activated**; current public authority stops at Combat entry | Task008 A1c→A2→B–H, then dormant009–019 → public020–021 → evidence022–024 |
...
**Status:** Parent003 authority contract freeze complete; no Combat runtime capability is active.
Owner accepted POL-001–008 and the corrected combined plan at `a10a588`. D2c.4 now composes 28
creation-rooted traces and freezes the exact Task004 handoff. Task004 and checkpoint B stay open. The
