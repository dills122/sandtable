...
| Dormant Core,005–019 | Task005 selected tables, arithmetic and strict artifact codec are implemented. Next implement Task006 content, loss-capable state, strict restore, private decisions, settlement, Reserve Release, relation-aware Movement, and guarded repeat/finish in dependency order. Every state-changing family needs replay cuts and recovery evidence before a dependent task starts. |
...
| Combat and continual cycle | Contract checkpoint B accepted; dormant Task005 Rules/arithmetic/codec implemented | **Gameplay not activated**; current public authority stops at Combat entry | Checkpoint B/Task005 complete → dormant006–019 → public020–021 → evidence022–024 |
