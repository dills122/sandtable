...
| Combat | Research decision-ready; `CMB-DES-001` identity design complete for review; implementation not started | Next: `CMB-DES-002` sealed protocol; research rulings and remaining design gates stay open |
...
| 5 — Combat and continual-cycle loop | Research decision-ready; bounded identity design complete for review; not implementation-ready | Complete remaining Contact/Combat/cycle design and research rulings before contract freeze |
...
internal authority from outward references. Next: `CMB-DES-002` sealed decision/event/readback
protocol and fallback; remaining design and research approval gates stay open.
