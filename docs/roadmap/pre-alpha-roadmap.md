...
| Dormant Core,005–019 | Foundations, creation and selected inherited adapters are implemented. [Initial H](../design/combat-cycle-implementation-plan.md#task008-execution-index) is accepted with 368 exact restore roots across 286 retained histories; actual-publication evidence remains open. Tasks009–016 are accepted: identity, selection, private orders, atomic costs, deterministic results, losses, retreat, custody, relationships and round closure. Isolated Release base validation017A1 is also accepted; isolated lifecycle017A2 is accepted with timed choices, fallback, replay and explicit completion. Task017B connects settled Combat to empty Release. The held-I no-move predecessor now replays actual first opening through empty Combat without releasing the unit. Task017C connects that history to native release-I and deterministic conversion fallback. Task018A adds relationship-aware costs;018B adds isolated atomic ordinary Movement/replay. Task019A adds pure trusted-boundary Movement witnesses. Task019B authenticates inherited released-I progress/armed continuation. Task019C adds authenticated guarded repeat/finish for that path. Next:actual repeated Movement, settled source/progress integration, then later-II/consumed lineage; [bounded delivery plan](../design/combat-cycle-movement-delivery-plan.md). Every state-changing family retains cumulative replay and recovery obligations. |
...
is not yet playable: later Reserve lineage, public Combat actions, the full continual cycle,
...
| --- | --- |
| Combat critical path | Dormant authority accepted through015 →016–019 closure/release/repeat → public020–021 → Runner022–024 → closeout025. Actual publication evidence remains open. |
...
retains exact checks and limits. Task016 relationship/round closure is accepted at `d480556` after full2,331/Boundary81, clean build/format, three Ready reviews and exact-candidate CI; [closure evidence](../../.planning/combat-task008-delivery/task016-evidence.md) records scope. Task017A1 isolated base validation is accepted at `77ef166` after full2,337/Boundary81, clean build/format, three Ready reviews and exact CI; [A1 evidence](../../.planning/combat-task008-delivery/task017a1-evidence.md) records44base hashes and explicit exclusions. Native isolated Release lifecycle017A2 is accepted at `a4b4f63` after full2,347/Boundary81, clean build/format, three Ready reviews (third full rebuild) and exact CI; [A2 evidence](../../.planning/combat-task008-delivery/task017a2-evidence.md) records44isolated traces/132event hashes/176state cuts/two terminal literals. Task017B native settled-empty adapter is accepted at `3c9aad3` after full2,354/Boundary81, clean build/format, three Ready reviews (third full rebuild) and exact CI; [B evidence](../../.planning/combat-task008-delivery/task017b-evidence.md) records32 native source contexts preserving settled World through Release opening/completion. Task017C now implements first positive release-I from actual held-I history. Parent017 remains open for later-II/consumed campaign lineage. HOST-PUB-001 publication evidence remains open. D2c.4 contract evidence covers28creation-rooted
