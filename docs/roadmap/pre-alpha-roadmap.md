...
| Dormant Core,005–019 | Tasks005–007 and Task008 A0/A1a/A1b are implemented and merged. A1c creation request/Created11 is implemented and independently reviewed on the current feature branch; Task008 parent remains open. [A2 Snapshot12 and B–H](../design/combat-cycle-implementation-plan.md#task008-execution-index) follow accepted A1c. Private decisions, settlement, Reserve Release, relation-aware Movement and guarded repeat/finish follow their dependencies. Every state-changing family needs replay cuts and recovery evidence before dependent activation. |
