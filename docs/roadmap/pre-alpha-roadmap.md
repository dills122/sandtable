...
| Dormant Core,005–019 | Tasks005–007 and Task008 A0/A1a/A1b are implemented and merged. A1c creation request/Created11 is reviewed in PR124; A2 creation-only Snapshot12 is reviewed in PR125. B1 opening replay is reviewed in PR126; C Weather replay is reviewed in PR127. B2 stage-entry is reviewed in PR128. D1 own Reserve designation is reviewed in PR129; D2 completion codecs are reviewed in PR130. Task019A same-event atomic projection implements the full retained Reserve history and Movement-entry handoff; Movement adjudication remains next. [B–H](../design/combat-cycle-implementation-plan.md#task008-execution-index) follow accepted A2; Task008 parent and actual-publication proof remain open. Private decisions, settlement, Reserve Release, relation-aware Movement and guarded repeat/finish follow their dependencies. Every state-changing family needs replay cuts and recovery evidence before dependent activation. |
