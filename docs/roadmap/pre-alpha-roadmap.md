...
| Combat | Research decision-ready; `CMB-DES-001`-`004` bounded designs complete for review; implementation not started | Next: `CMB-DES-005` settlement/disclosure; research rulings and remaining design gates stay open |
...
| 5 — Combat and continual-cycle loop | Research decision-ready; bounded identity/protocol/step/resolution designs complete for review; not implementation-ready | Complete remaining Contact/Combat/cycle design and research rulings before contract freeze |
...
extension boundaries. Next: `CMB-DES-005` settlement/disclosure; remaining approval gates stay open.
...
DES-001/DES-002/DES-003 with no actionable findings; it does not cover subsequent DES-004 or
approve production.
