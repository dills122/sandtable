...
| Movement and contact | Movement Foundation is complete through merged `MOV-TASK-010` / PR #79; approved ZOC/Reaction implementation has begun with dormant `ZOR-TASK-002A` Rules predicates | Complete `ZOR-TASK-002A`, then proceed to the dormant Content successor in `002B`; Breakdown adjudication remains a separate gate |
...
| 4 — Movement, Breakdown, and Reaction boundary | Active | Movement Tasks 001-010 are complete and merged; the ZOC/Reaction package is approved and `ZOR-TASK-002A` is the first active slice, while Breakdown adjudication remains separate |
...
`MOV-TASK-010` / PR #79, and approved ZOC/Reaction implementation has begun with `ZOR-TASK-002A`.
...
[technical design](../design/zoc-reaction-v1.md); `ZOR-TASK-002A` is its first bounded slice.
...
lane is the approved ZOC/Reaction package, beginning with `ZOR-TASK-002A`. Its Rules, Content, Campaign,
...
| --- | --- | --- |
| ZOC/Reaction authority lane | Stable approved requirements, technical design, task slices, and traceability from accepted `CONTACT-001` rulings | `ZOR-TASK-002A` is the active first slice; approval did not collapse the dependency graph into one change |
...
package. Its dependency-ordered implementation begins with dormant Rules slice `ZOR-TASK-002A`.
...
| `CONTACT-001` | Decision-complete; all five rulings accepted in PR #71; ZOC/Reaction spec/design approved after PR #80 merged | `ZOR-TASK-002A` is the first implementation slice; Contact/Engaged remain Sprint 5 |
...
[technical design](../design/zoc-reaction-v1.md) are approved; `ZOR-TASK-002A` is the first bounded
implementation slice and leaves ruleset 7 active.
...
[technical design](../design/zoc-reaction-v1.md); the package is approved and `002A` is the first
