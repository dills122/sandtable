...
| `STG-TASK-008` | Migrate all checked Exercise/Maneuver manifests and their governing identity examples to the accepted identities and exact canonical bytes. The retained fixtures later clean-cut to v2 under Reserve Designation. | `scenarios/exercises/rules-lab.organization.v2.json`; `scenarios/exercises/rules-lab.organization.baseline.v2.json`; `scenarios/maneuvers/rules-lab.serial.v2.json`; `docs/specs/exercise-harness-v1.md`; `docs/specs/weather-determination-v1.md` | 006 |
