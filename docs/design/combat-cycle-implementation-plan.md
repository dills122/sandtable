...
| `008H2` Movement/Breakdown retained-history router | Accepted H1 and E1/E2G1/G2 | Derive ordinary moves, mandatory stop/resolution/completion and Breakdown completion from one stream | Implementation active; Reaction H3 and full-root restore H4 remain open | No |
