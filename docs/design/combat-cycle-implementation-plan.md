...
| `008H3` Reaction retained-history router | Accepted H2 and F1–F6 | Derive trigger, participant, closure, fallback and second-move forks from one stream | Implementation active; literal full-root restore H4 remains open | No |
