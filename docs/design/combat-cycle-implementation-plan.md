...
| `008F` Reaction adapter, parent | F1–F6 below | Selected trigger/participant/closure histories, position/owner privacy and unsupported-profile rejection | Open; bounded causal children below | No |
