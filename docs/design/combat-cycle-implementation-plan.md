...
| `008F1` Reaction trigger | E1 first-move cut | Real return Move4, adjacency/eligibility, persisted window/opportunity and reacting flow | Implemented and reviewed on `codex/combat-task008-reaction-trigger`; focused15/full2,051 pass, three Ready rounds | No |
| `008F2` participant lifecycle | F1 | Reactor move3, participant completion3, System empty stop resolution2 and no-eligible closure3 | Pending | No |
...
| `008G2` Breakdown completion | E2/G1 | System completion from actual end proof into Combat entry; preserve World/RNG and receipts | Implemented and reviewed on `codex/combat-task008-breakdown-completion`; focused24/full2,044 pass, three Ready rounds | No |
