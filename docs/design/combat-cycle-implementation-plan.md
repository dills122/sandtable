...
| `008E` Movement adapter, parent | E1 and E2/G1 below | Move/stop/completion event parity, CP/DP/history and old-context rejection | Open; E1 accepted, E2/G1 route lifecycle next | No |
...
| `008E2/G1` route lifecycle | E1 | Owner stop2, System empty-cohort resolution2, owner Movement completion3 and actual end proof | Pending; shared Movement/Breakdown ownership | No |
